...
select2.innerHTML = ""
for(var key2 in obj[selectedValue]){
    select2.innerHTML += `<option value="${key2}">${key2}</option>`
}
...
getDiv.innerHTML = ""
 for(var key in obj[select1.value][select2.value]){
        getDiv.innerHTML += `${key} : ${obj[select1.value][select2.value][key]} <br>`
}
